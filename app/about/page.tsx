...
const about = () => {
  ...
  <img src='https://velisaafrica.co.za/wp-content/uploads/2018/03/Velisa-Landscape-Logo.png' alt='logo'className='w-[100%] h-[100%] flex justify-center lg:w-[50%] lg:h-[50%]  lg:mb-2 lg:mt-[15%]' />
  </div>
  <div className='lg:flex-1  '>

    
    <h1 className='text-3xl font-semibold mb-4 flex justify-center text-green-700 '>Velisa Africa Web Agency</h1>
...
<div className="container mx-auto my-8 ">
      <h2 className="text-3xl font-semibold mb-4 flex justify-center text-green-700">Meet the Team</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6  ">
        
        {teams.map((team) => (
          <div key={team.id} className=" p-4 rounded-lg shadow-md h-full flex flex-col justify-center items-center border-2">
            <img src={team.img} className='w-16 h-16  rounded-3xl'/>
    ...
    <div
  className="pb-30 pt-30 bg-gradient-to-r from-transparent via-transparent to-transparent bg-repeat-x border-r-0 border-l-0 h-[100%] container mx-auto my-8"
  
  >
<h2 className="text-3xl font-semibold mb-4 flex justify-center text-green-700">Previous Clients</h2>
<div className='flex flex-row justify-center space-x-5'>
  <img src='https://www.swervedesigns.co.za/wp-content/uploads/DND-LOGO.png' className='w-[10%] h-[10%]'/>
  <img src='https://www.swervedesigns.co.za/wp-content/uploads/DND-LOGO.png' className='w-[10%] h-[10%]'/>
  <img src='https://www.swervedesigns.co.za/wp-content/uploads/DND-LOGO.png' className='w-[10%] h-[10%]'/>
  <img src='https://www.swervedesigns.co.za/wp-content/uploads/DND-LOGO.png' className='w-[10%] h-[10%]'/>
  <img src='https://www.swervedesigns.co.za/wp-content/uploads/DND-LOGO.png' className='w-[10%] h-[10%]'/>
